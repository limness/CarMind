...
public class StartamentActivity extends AppCompatActivity {
    ...
    private ImageView buttonStatement;
    private ImageView fieldTelephone;
    private ImageView fieldBusiness;
    private ImageView fieldAdress;

    private TextView businessFieldHelp;
    private TextView adresFieldHelp;
    private TextView loginPanel;
    private TextView paydown;
    private TextView aboutService;
    private TextView becomePartner;
    private TextView balance;
    private TextView textStartament;
    private TextView allOkey;
    ...
    public String nose;
    private static String URL_REGIST_INPUT = "http://kostya2l.beget.tech/partners.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_startament);
        ...
        textStartament = findViewById(R.id.textStartament);
        fieldTelephone = findViewById(R.id.fieldTelephone);
        telephoneField = findViewById(R.id.telephoneField);
        fieldBusiness = findViewById(R.id.fieldBusiness);
        businessField = findViewById(R.id.businessField);
        businessFieldHelp = findViewById(R.id.businessFieldHelp);
        fieldAdress = findViewById(R.id.fieldAdress);
        adressField = findViewById(R.id.adressField);
        adresFieldHelp = findViewById(R.id.adresFieldHelp);
        allOkey = findViewById(R.id.allOkey);

        buttonStatement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String telephone = telephoneField.getText().toString().trim();
                String typebusiness = businessField.getText().toString().trim();
                String adresbusiness = adressField.getText().toString().trim();

                if (telephone.isEmpty() || typebusiness.isEmpty() || adresbusiness.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Заполните все поля!", Toast.LENGTH_SHORT).show();
                } else {
                    textStartament.setVisibility(View.GONE);
                    fieldTelephone.setVisibility(View.GONE);
                    telephoneField.setVisibility(View.GONE);
                    fieldBusiness.setVisibility(View.GONE);
                    businessField.setVisibility(View.GONE);
                    businessFieldHelp.setVisibility(View.GONE);
                    fieldAdress.setVisibility(View.GONE);
                    adressField.setVisibility(View.GONE);
                    adresFieldHelp.setVisibility(View.GONE);
                    buttonStatement.setVisibility(View.GONE);

                    inputFile(telephone, typebusiness, adresbusiness);
                    allOkey.setText("Ваша заявка была принята!" + "\n" + "В ближайшее время мы с вами свяжемся");
                    allOkey.setVisibility(View.VISIBLE);
                }
            }
        });
    ...
    public void inputFile(final String telephone, final String typeofbusiness, final String addressofbusiness) {
        StringRequest request = new StringRequest(Request.Method.POST, URL_REGIST_INPUT, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put ("addressofbusiness", addressofbusiness);
                return params;
            }
        };
